...
var DataWriter = /** @class */ (function () {
    ...
    DataWriter.prototype.readFrom = function (filePath) {
    ...
    DataWriter.prototype.findInto = function (filePath, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
    ...
    DataWriter.prototype.appendTo = function (filePath, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                fs_1.default.readFile(filePath, function (err, oldData) {
                    if (err)
                        console.error;
                    if (!oldData)
                        return fs_1.default.appendFile(filePath, data, function (err) {
                            if (err)
                                console.error;
                        });
                    var json = JSON.parse(oldData.toString());
