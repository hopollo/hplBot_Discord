...
var StreamElementsScrapper = /** @class */ (function () {
    function StreamElementsScrapper(msg, url, cmd) {
        this._msg = msg;
        this._url = url;
        this._cmd = cmd;
        this.fetchBotCommands();
    }
    StreamElementsScrapper.prototype.fetchBotCommands = function () {
                ...
                getData = function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                _a.sent();
                                return [4 /*yield*/, page.waitForSelector('tr.md-row', { visible: true })];
                            case 4:
                                _a.sent();
                                return [4 /*yield*/, page.evaluate(function () {
                                        return Array.from(document.querySelectorAll('tr.md-row'))
                                            .map(function (i) { return i.children; })
                                            .reduce(function (a, b) { return (a[b[0].innerHTML.slice(0, -1)] = b[1].innerHTML
                                            .replace('/me', '')
                                            , a); }, {});
                                    })];
                            case 5:
    ...
    return StreamElementsScrapper;
}());
exports.StreamElementsScrapper = StreamElementsScrapper;
